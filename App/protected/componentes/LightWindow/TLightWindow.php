...
class TLightWindow extends TTemplateControl {
    ...
    {
        $tarfile = Prado::getPathOfNamespace('Application.componentes.LightWindow.LightWindow', '.tar');
        $md5sum = Prado::getPathOfNamespace('Application.componentes.LightWindow.LightWindow', '.md5');
